...
<body>
	...
	<main>
		...
		<label>Name</label><br>
		<input type="text" name ="name" class="textsec" ><br>
		<label>Email</label><br>
		<input type="text" name ="email" class="textsec"><br>
		<label>Contact</label><br>
		<input type="text" name="contact" class="textsec"><br>
		<label>Feedback</label><br>
		<textarea name="feedback" rows="4" cols="50">Enter your feedback here..</textarea><br>
