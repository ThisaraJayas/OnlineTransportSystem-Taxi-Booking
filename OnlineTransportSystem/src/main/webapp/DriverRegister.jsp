...
<main>
<a href="UserRegister.jsp"><input type="submit" value="User Register" class="addbtndriver"></a>
	<div class="box">
		<h1>Driver Register</h1>
		<form action="driverregser" method="post">
			<div class="text-box">
				<label>Name</label><br>
				<input type="text" class="date" name="name" required>
			</div>
			<div class="text-box">
			...
			<div class="text-box">
				<label>Already have an account? <a href="DriverLogin.jsp">Login</a></label><br>
			</div>
