...
<main>
<a href="DriverLogin.jsp"><input type="submit" value="Driver Login" class="addbtndriver"></a>
	...
	<div class="box">
		...
		<form action="userloginserv" method="post">
			...
			<div class="text-box">
				<label>Don't have an account? <a href="UserRegister.jsp">Register</a></label><br>
			</div>
