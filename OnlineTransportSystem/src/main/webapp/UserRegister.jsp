...
<main>
<a href="DriverRegister.jsp"><input type="submit" value="Driver Register" class="addbtndriver"></a>

	<div class="box">
		<h1>Register</h1>
		
		<form action="userinsertser" method="post">
			<div class="text-box">
			...
			<div class="text-box">
				...
				<input type="text" class="date" name="email" required>
			</div>
			<div class="text-box">
				<label>Contact</label><br>
				<input type="text" class="date" name="contact" required>
			</div>
			<div class="text-box">
				<label>Password</label><br>
				<input type="password" class="date" name="password" required>
			</div>
			<div class="text-box">
				<label>Confirm Password</label><br>
				<input type="password" class="date" name="conpassword" required>
			</div>
			<div class="text-box">
				<label>Already have an account? <a href="UserLogin.jsp">Login</a></label><br>
			</div>
			<input type="submit" value="Register" class="addbtn">
		</form>
	</div>
	</main>
	<footer>
